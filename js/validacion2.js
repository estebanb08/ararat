...
function alertaSuccess() { 
  ...
  html:'<button class="btn btn-primary"><a href="Cap-PDeExtremidades.html"> Acceder</a></button>',
...
function validar1(){
    var usuarioValidar = "proteccionextremidades";
    var contraseñaValidar = "proteccion";
